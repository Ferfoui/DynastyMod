...
public class ModTileEntities {
    ...
    public static final RegistryObject<TileEntityType<TileEntitySoulInfuser>> SOUL_INFUSER_TILE_ENTITY = TILE_ENTITIES.register("soul_infuser_tile_entity", () -> TileEntityType.Builder.of(TileEntitySoulInfuser::new, ModBlocks.SOUL_INFUSER.get()).build(null));
