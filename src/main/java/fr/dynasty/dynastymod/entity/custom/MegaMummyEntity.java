package fr.dynasty.dynastymod.entity.custom;
...
public class MegaMummyEntity extends ZombieEntity {
    public MegaMummyEntity(EntityType<? extends ZombieEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void playStepSound(BlockPos pos, BlockState blockIn) {
        this.playSound(SoundEvents.HUSK_STEP, 0.20F, 0.5F);
    }
